...
<div class="siddhi-checkout">
                                        ...
                                        <div class="custom-control col-lg-12 mb-3 position-relative" id="address_box"
                                            ...
                                            <div class="addres-innerbox">
                                                ...
                                                <div class="p-3 w-100">
                                                    ...
                                                    <p class="text-dark m-0" id="line_2">{{trans('lang.rewood_city')}}
                                                    </p>
                                        ...
                                        <form>
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-12 form-group mb-0">
                                                    ...
                                                    <label
                                                        class="form-label small font-weight-bold">{{trans('lang.select_bank')}}</label><br>
                    ...
                    <form class="">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-12 form-group"><label
                                    ...
                                    id="address_city" type="text" class="form-control"></div>
    ...
    async function getUserDetails() {
        ...
        userDetailsRef.get().then(async function(userSnapshots) {
            ...
            if (userDetails.hasOwnProperty('shippingAddress') && userDetails.shippingAddress !=
                undefined) {
        ...
        if (main_vendor_id) {
            try {
                uservendorDetailsRef.where('vendorID', "==", main_vendor_id).get().then(async function(
                    uservendorSnapshots) {
