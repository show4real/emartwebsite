...
<div class="modal fade" id="book_a_table" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group row">
                    <div class="col-6">
                        <input class="form-control guest_first_name" id="guest_name" type="text" placeholder="First Name">
                    </div>
                    <div class="col-6">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" value="birthday" name="special_occassion" id="birthday">
                    <label class="form-check-label" for="birthday">
                        {{trans('lang.birthday')}}
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="special_occassion" value="anniversary" id="anniversary">
                    <label class="form-check-label" for="anniversary">
                        {{trans('lang.anniversary')}}
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input first_visit" type="checkbox" name="first_visit" value="first_visit" id="first_visit">
                ...
                <div class="form-group row col-12 mt-3">
                    ...
                    <input class="form-control special_request" id="date" type="text" placeholder="Type your request here">
                </div>
        ...
        <div class="col-md-8 pt-3 vendor-detail-left">
                ...
                <div class="bg-white p-3 border rounded-lg mb-3 table-book-view">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="float-right add-btn ml-auto">
                            <span class="menu-itemimg"><a href="<?php echo route('vendor') . '?id=' . $_GET['id']; ?>">
                    ...
                    <div class="d-flex align-items-center">
                        <div class="media align-items-center">
                            ...
                            <div class="media-body">
                                ...
                                <p class="text-muted mb-0">{{trans('lang.get_instant_confirmation')}}</p>
                            </div>
                        </div>
                        <div class="float-right add-btn ml-auto">
                            <?php if (Auth::check()) { ?>
                                <span class="menu-itemimg" id="table_book_btn" type="button" data-toggle="modal" data-target="#book_a_table"><img src="img/next.png"></span>
                            <?php } else { ?>
                                <a href="<?php echo route('login'); ?>"><span class="menu-itemimg" type="button"><img src="img/next.png"></span></a>
                            <?php }  ?>
                        </div>
                    </div>
                </div>
            ...
            <div class="dyn-menulist mb-4 border-bottom pb-4">
                <div class="pb-2 d-flex align-items-center">
                    ...
                    <button class="view_all_menu_btn btn ml-auto" onclick="showAllMenu()">{{trans('lang.view_all')}}</button>
                </div>
        ...
        <div class="col-md-4 pt-3 vendor-detail-right">
            ...
            <div class="siddhi-cart-item rounded rounded shadow-sm overflow-hidden bg-white sticky_sidebar" id="cart_list">
                <div class="sidebar-header p-3">
                    ...
                    <a class="vendor_direction" target="_blank" href=""><img src="img/direction.png"> {{trans('lang.directions')}}</a>
...
<!-- <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBJA_hkZfMcOtoPzF3k-RYI-KNjLXgrp_8&callback=myMap"></script>
 -->
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBJA_hkZfMcOtoPzF3k-RYI-KNjLXgrp_8&v=weekly" defer></script>
