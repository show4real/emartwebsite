...
<head>
    ...
    <link rel="icon" type="image/png" href="img/emart2.png">
...
<body class="fixed-bottom-bar">
                ...
                <div class="row align-items-center">
                    <div class="col-1">
                        <a href="home.html" class="brand-wrap mb-0">
                            <img alt="#" class="img-fluid" src="img/emart2.png">
                        </a>
                                ...
                                <div class="osahan-country">
                                    <div class="search_location bg-primary p-3 text-right">
                                        <div class="input-group rounded shadow-sm overflow-hidden">
                                            ...
                                            <input type="text" class="shadow-none border-0 form-control" placeholder="{{trans('lang.enter_location')}}">
                                        </div>
                                    </div>
                                    <div class="p-3 border-bottom">
                                        <a href="home.html" class="text-decoration-none">
                                            <p class="font-weight-bold text-primary m-0"><i class="feather-navigation"></i>{{trans('lang.new_york')}}</p>
                                        </a>
                                    </div>
                                    <div class="filter">
                                        <h6 class="px-3 py-3 bg-light pb-1 m-0 border-bottom">
                                            {{trans('lang.choose_your_country')}}
                                        </h6>
                                        <div class="custom-control  border-bottom px-0 custom-radio">
                                            <input type="radio" id="customRadio1" name="location" class="custom-control-input">
                                            <label class="custom-control-label py-3 w-100 px-3" for="customRadio1">{{trans('lang.afghanistan')}}</label>
                                        </div>
                                        <div class="custom-control  border-bottom px-0 custom-radio">
                                            <input type="radio" id="customRadio2" name="location" class="custom-control-input" checked="">
                                            <label class="custom-control-label py-3 w-100 px-3" for="customRadio2">{{trans('lang.india')}}</label>
                                        </div>
                                        <div class="custom-control  border-bottom px-0 custom-radio">
                                            <input type="radio" id="customRadio3" name="location" class="custom-control-input">
                                            <label class="custom-control-label py-3 w-100 px-3" for="customRadio3">{{trans('lang.usa')}}</label>
                                        </div>
                                        <div class="custom-control  border-bottom px-0 custom-radio">
                                            <input type="radio" id="customRadio4" name="location" class="custom-control-input">
                                            <label class="custom-control-label py-3 w-100 px-3" for="customRadio4">{{trans('lang.australia')}}</label>
                                        </div>
                                        <div class="custom-control  border-bottom px-0 custom-radio">
                                            <input type="radio" id="customRadio5" name="location" class="custom-control-input">
                                            <label class="custom-control-label py-3 w-100 px-3" for="customRadio5">{{trans('lang.japan')}}</label>
                                        </div>
        ...
        <i class="feather-search h6 mr-2 mb-0"></i> <span>{{trans('lang.search')}}</span>
                                        ...
                                        <div class="dropdown mr-4 m-none">
                                            <a href="#" class="dropdown-toggle text-dark py-3 d-block" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                <img alt="#" src="img/user/1.jpg" class="img-fluid rounded-circle header-user mr-2 header-user"> Hi
                                                Osahan
                                            </a>
                    ...
                    <div class="bg-white rounded shadow-sm sticky_sidebar overflow-hidden">
                        <a href="profile.html" class="">
                            <div class="d-flex align-items-center p-3">
                                ...
                                <div class="right">
                                    ...
                                    <p class="text-muted m-0 small"><span class="__cf_email__" data-cfemail="a4cdc5c9cbd7c5ccc5cae4c3c9c5cdc88ac7cbc9">[email&#160;protected]</span>
                                    </p>
                                </div>
                            </div>
                        </a>
                        ...
                        <div class="bg-white profile-details">
                            ...
                            <a href="{{ route('faq') }}" class="d-flex w-100 align-items-center border-bottom px-3 py-4">
                                <div class="left mr-3">
                                    <h6 class="font-weight-bold m-0 text-dark"><i class="feather-truck bg-danger text-white p-2 rounded-circle mr-2"></i>{{trans('lang.delivery_support')}}
                                    </h6>
                                </div>
                                <div class="right ml-auto">
                                    <h6 class="font-weight-bold m-0"><i class="feather-chevron-right"></i></h6>
                    ...
                    <div class="osahan-cart-item-profile">
                        <div class="box bg-white mb-3 shadow-sm rounded">
                            <div class="p-3 d-flex align-items-center">
                                ...
                                <div class="ml-3">
                                    <h6 class="text-dark mb-2 mt-0">{{trans('lang.forum')}}</h6>
                                    <p class="mb-0 text-muted">{{trans('lang.forum_help')}}
                                    </p>
                                </div>
                            </div>
                            <div class="overflow-hidden border-top d-flex align-items-center p-3">
                                <a class="font-weight-bold d-block" href="#">{{trans('lang.help_forum')}} </a>
                        ...
                        <div class="box bg-white mb-3 shadow-sm rounded">
                            ...
                            <div class="overflow-hidden border-top d-flex align-items-center p-3">
                                <a class="font-weight-bold d-block" href="#"> {{trans('lang.swiggiweb_safety_center')}}
                                </a>
                                <i class="feather-arrow-right-circle ml-auto text-primary"></i>
                            </div>
                        </div>
                ...
                <div class="row pt-3">
                    <aside class="col-md-4 footer-about">
                        <article class="d-flex pb-3">
                            <!-- <div><img alt="#" src="img/emart2.png" class="logo-footer mr-3"></div> -->
                            <div>
                    ...
                    <aside class="col-sm-3 col-md-2 text-white">
                        ...
                        <ul class="list-unstyled hov_footer">
                            <li> <a href="{{ route('faq') }}" class="text-muted">{{trans('lang.delivery_support')}} </a>
                            </li>
                            <li> <a href="{{url('contact_us')}}" class="text-muted">{{trans('lang.contact_us')}} </a>
                            </li>
                            <li> <a href="{{ route('terms') }}" class="text-muted">{{trans('lang.terms_use')}} </a></li>
                            <li> <a href="{{ route('privacy') }}" class="text-muted">{{trans('lang.privacy_policy')}}
                                </a></li>
                        </ul>
                    </aside>
                    <aside class="col-sm-3  col-md-2 text-white">
                        ...
                        <ul class="list-unstyled hov_footer">
                            ...
                            <li> <a href="forgot_password.html" class="text-muted">{{trans('lang.forgot_password')}}
                                </a></li>
                    ...
                    <aside class="col-sm-3  col-md-2 text-white">
                        ...
                        <ul class="list-unstyled hov_footer">
                            ...
                            <li> <a href="most_popular.html" class="text-muted"> {{trans('lang.most_popular')}} </a>
                            </li>
    ...
    <nav id="main-nav">
        <ul class="second-nav">
            ...
            <li><a href="successful.html"><i class="feather-check-circle mr-2"></i> {{trans('lang.successful')}} </a>
            </li>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p class="small">WE ACCEPT <span class="osahan-card ml-2 font-weight-bold">( Master Card / Visa Card
                            / Rupay )</span></p>
                    <form>
                        <div class="form-row">
                            ...
                            <div class="col-md-8 form-group"><label class="form-label font-weight-bold small">{{trans('lang.valid_through_mm_yy')}}
                                </label><input placeholder="Enter Valid through(MM/YY)" type="number" class="form-control"></div>
                            ...
                            <div class="col-md-12 form-group"><label class="form-label font-weight-bold small">{{trans('lang.name_on_card')}}
                                </label><input placeholder="Enter Card number" type="text" class="form-control"></div>
                            <div class="col-md-12 form-group mb-0">
                                <div class="custom-control custom-checkbox"><input type="checkbox" id="custom-checkbox1" class="custom-control-input"><label title="" type="checkbox" for="custom-checkbox1" class="custom-control-label small pt-1">Securely save
                                        this card for a faster checkout next time.</label></div>
                            </div>
                        </div>
                    </form>
                </div>
                <div class="modal-footer p-0 border-0">
                    ...
                    <div class="col-6 m-0 p-0">
                        <button type="button" class="btn btn-primary btn-lg btn-block">{{trans('lang.save_changes')}}
                        </button>
                    </div>
                </div>
            </div>
                        ...
                        <div class="form-row">
                            <div class="col-md-12 form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append"><button type="button" class="btn btn-outline-secondary"><i class="feather-map-pin"></i></button>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="modal-body py-0">
                    ...
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <div>
                            ...
                            <P class="mb-0 small"><a href="https://askbootstrap.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="6e050f1a0b1d07031e1d01002e011b1a0c010105400d0103">[email&#160;protected]</a>
                            </P>
                        </div>
                    </div>
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <div>
                            ...
                            <P class="mb-0 small"><a href="https://askbootstrap.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="65040b0117001216080c110d25100c5d4b060a08">[email&#160;protected]</a>
                            </P>
                        </div>
                    </div>
                </div>
