...
<?php
$countries = asset('countriesdata.json');
    ...
    <div class="col-md-6">
      <div class="col-10 mx-auto card p-3">
        ...
        <form class="mt-3 mb-4" action="#" onsubmit="return loginClick()" id="login-box">
          ...
          <button type="button" onclick="loginWithPhoneClick()" id="loginphon_btn" class="btn btn-dark btn-lg btn-block text-uppercase waves-effect waves-light btn btn-primary">{{ __('Login') }}
            {{trans('lang.with_phone')}}</button>
        ...
        <form class="form-horizontal form-material" name="loginwithphon" id="login-with-phone-box" action="#" style="display:none;">
          ...
          <div class="form-group " id="phone-box">
            <div class="col-xs-12">
              ...
              <input class="form-control" placeholder="{{trans('lang.user_phone')}}" id="phone" type="phone" class="form-control" name="phone" value="{{ old('phone') }}" required autocomplete="phone" autofocus>
            </div>
            @error('phone')
          ...
          <div class="form-group text-center m-t-20">
            <div class="col-xs-12">
              ...
              <button type="button" onclick="loginBackClick()" class="btn btn-dark btn-lg btn-block text-uppercase waves-effect waves-light btn btn-primary">{{ __('Login') }}
                {{trans('lang.with_email')}}</button>
...
<script type="text/javascript">
  ...
  function sendOTP() {
    ...
    if (jQuery("#phone").val() && jQuery("#country_selector").val()) {
      ...
      database.collection("users").where("phoneNumber", "==", phoneNumber).where("role", "==", 'customer').get().then(
