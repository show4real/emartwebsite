                                ...
                                <div class="osahan-country">
                                    <div class="search_location bg-primary p-3 text-right">
                                        <div class="input-group rounded shadow-sm overflow-hidden">
                                            <div class="input-group-prepend">
                                                <button
                                                    class="border-0 btn btn-outline-secondary text-dark bg-white btn-block"><i
                                    ...
                                    <div class="p-3 border-bottom">
                                        <a href="home.html" class="text-decoration-none">
                                            <p class="font-weight-bold text-primary m-0"><i
                                                    class="feather-navigation"></i> New York, USA</p>
                                        </a>
                                    </div>
                                    <div class="filter">
                        ...
                        <div class="d-flex align-items-center justify-content-end pr-5">
                            ...
                            <div class="dropdown mr-4 m-none">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                                    ...
                                    <a class="dropdown-item"
                                        href="{{url('contact_us')}}">{{trans('lang.contact_us')}}</a>
                            ...
                            <div class="d-flex align-items-center p-3">
                                ...
                                <div class="right">
                                    ...
                                    <p class="text-muted m-0 small"><span class="__cf_email__"
                                            data-cfemail="a4cdc5c9cbd7c5ccc5cae4c3c9c5cdc88ac7cbc9">[email&#160;protected]</span>
                                    </p>
                                </div>
                            </div>
                        </a>
                            ...
                            <div id="accountAccordion">
                                ...
                                <div class="box border-bottom bg-white mb-2 rounded shadow-sm overflow-hidden">
                                    ...
                                    <div id="accountCollapseOne" class="collapse show"
                                        aria-labelledby="accountHeadingOne" data-parent="#accountAccordion">
                                        <div class="card-body border-top p-3 text-muted">
                                            {{trans('lang.anim_pariatur_message')}}
                                        </div>
                                    </div>
                                ...
                                <div class="box border-bottom bg-white mb-2 rounded shadow-sm overflow-hidden">
                                    ...
                                    <div id="accountCollapseThree" class="collapse"
                                        aria-labelledby="accountHeadingThree" data-parent="#accountAccordion">
                                        <div class="card-body border-top p-3 text-muted">
                                            {{trans('lang.anim_pariatur_message')}}
                                        </div>
                                    </div>
                    ...
                    <aside class="col-sm-3 col-md-2 text-white">
                        ...
                        <ul class="list-unstyled hov_footer">
                            ...
                            <li> <a href="{{ route('privacy') }}"
                                    class="text-muted">{{trans('lang.privacy_policy')}}</a></li>
                        </ul>
                    </aside>
                    <aside class="col-sm-3  col-md-2 text-white">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-12 form-group mb-0">
                                <div class="custom-control custom-checkbox"><input type="checkbox" id="custom-checkbox1"
                                        ...
                                        for="custom-checkbox1" class="custom-control-label small pt-1">Securely save
                ...
                <div class="modal-footer p-0 border-0">
                    ...
                    <div class="col-6 m-0 p-0">
                        <button type="button"
                            class="btn btn-primary btn-lg btn-block">{{trans('lang.save_changes')}}</button>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="modal-body py-0">
                    ...
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <div>
                            ...
                            <P class="mb-0 small"><a href="https://askbootstrap.com/cdn-cgi/l/email-protection"
                                    class="__cf_email__"
                                    data-cfemail="6e050f1a0b1d07031e1d01002e011b1a0c010105400d0103">[email&#160;protected]</a>
                            </P>
                        </div>
                    </div>
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <div>
                            ...
                            <P class="mb-0 small"><a href="https://askbootstrap.com/cdn-cgi/l/email-protection"
                                    class="__cf_email__"
                                    data-cfemail="65040b0117001216080c110d25100c5d4b060a08">[email&#160;protected]</a>
                            </P>
                        </div>
                    </div>
                </div>
