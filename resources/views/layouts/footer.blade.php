...
<span style="display: none;">
    <button type="button" class="btn btn-primary" id="notification_accepted_order_by_vendor_id" data-toggle="modal" data-target="#notification_accepted_order_by_vendor">Large modal</button>
</span>
<div class="modal fade" id="notification_accepted_order_by_vendor" tabindex="-1" role="dialog" aria-labelledby="notification_accepted_order_by_vendor" aria-hidden="true">
...
<span style="display: none;">
    <button type="button" class="btn btn-primary" id="notification_rejected_order_by_vendor_id" data-toggle="modal" data-target="#notification_rejected_order_by_vendor">Large modal</button>
</span>
<div class="modal fade" id="notification_rejected_order_by_vendor" tabindex="-1" role="dialog" aria-labelledby="notification_accepted_order_by_vendor" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered notification-main" role="document">
        <div class="modal-content">
            <div class="modal-header justify-content-center">
            ...
            <div class="modal-body">
                <h6 class="driver_name"></h6>
                <h6> {{trans('lang.has_reject_your_order')}}</h6>
            </div>
            <div class="modal-footer">
                <?php if (@$_COOKIE['service_type'] == "Parcel Delivery Service") { ?>
...
<span style="display: none;">
    <button type="button" class="btn btn-primary" id="notification_accepted_order_id" data-toggle="modal" data-target="#notification_accepted_order">Large modal</button>
</span>
<div class="modal fade" id="notification_accepted_order" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered notification-main" role="document">
        <div class="modal-content">
            <div class="modal-header justify-content-center">
                <h5 class="modal-title text-center" id="exampleModalLongTitle">{{trans('lang.delivery_agent_assigned')}}
                </h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            ...
            <div class="modal-body">
                <h6 class="accept_name"></h6>
                <h6>{{trans('lang.will_deliver_your_order')}}</h6>
            </div>
            <div class="modal-footer">
                <?php if (@$_COOKIE['service_type'] == "Parcel Delivery Service") { ?>
...
<div class="modal fade" id="notification_accepted_dining_by_restaurant" tabindex="-1" role="dialog" aria-labelledby="notification_accepted_dining_by_restaurant" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered notification-main" role="document">
        <div class="modal-content">
            <div class="modal-header justify-content-center">
                <h5 class="modal-title" id="exampleModalLongTitle">{{trans('lang.your_dining_request_has_accepted')}}
                </h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
...
<div class="modal fade" id="notification_rejected_dining_by_restaurant" tabindex="-1" role="dialog" aria-labelledby="notification_rejected_dining_by_restaurant" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered notification-main" role="document">
        <div class="modal-content">
            <div class="modal-header justify-content-center">
                <h5 class="modal-title" id="exampleModalLongTitle">{{trans('lang.your_dining_request_has_rejected')}}
                </h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
...
<!-- Rental Notification -->
<span style="display: none;">
    <button type="button" class="btn btn-primary" id="notification_accepted_order_rental_driver_id" data-toggle="modal" data-target="#notification_accepted_order_by_driver">Large modal</button>
</span>
<div class="modal fade" id="notification_accepted_order_by_driver" tabindex="-1" role="dialog" aria-labelledby="notification_accepted_order_by_driver" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered notification-main" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h6 class="driver_name_"></h6>
                <h6>{{trans('lang.has_accept_booking')}}</h6>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-primary"><a href="{{url('rental_orders')}}" id="notification_accepted_rental_a">{{trans('Go')}}</a>
                </button>
            </div>
        </div>
    </div>
...
<span style="display: none;">
    <button type="button" class="btn btn-primary" id="notification_accepted_order_rental_id" data-toggle="modal" data-target="#notification_accepted_order_rental">Large modal</button>
</span>
<div class="modal fade" id="notification_accepted_order_rental" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered notification-main" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary"><a href="{{url('rental_orders')}}" id="notification_accepted_a">Go</a></button>
            </div>
        </div>
    </div>
</div>
...
<span style="display: none;">
    <button type="button" class="btn btn-primary" id="notification_order_complete_rental_id" data-toggle="modal" data-target="#notification_order_complete_rental">{{trans('lang.large_modal')}}</button>
</span>
    ...
    <div class="modal-dialog modal-dialog-centered notification-main" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <h6 class="driver_name_"></h6>
                <h6>{{trans('lang.has_booking_completed')}}</h6>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-primary"><a href="{{url('rental_orders')}}" id="">{{trans('lang.Go')}}</a></button>
            </div>
...
<span style="display: none;">
    <button type="button" class="btn btn-primary" id="notification_rejected_rental_order_id" data-toggle="modal" data-target="#notification_rejected_rental_id">{{trans('lang.large_modal')}}</button>
</span>

<div class="modal fade" id="notification_rejected_rental_id" tabindex="-1" role="dialog" aria-labelledby="notification_rejected_dining_by_restaurant" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered notification-main" role="document">
        <div class="modal-content">
            <div class="modal-header justify-content-center" style="display: block;">
                <h5 class="modal-title text-center" id="exampleModalLongTitle">{{trans('lang.booking_rejected')}}</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <h6 class="driver_name_"></h6>
                <h6>{{trans('lang.has_booking_rejected')}}
                </h6>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-primary"><a href="{{url('rental_orders')}}" id="notification_rejected_dining_by_restaurant_a">{{trans('lang.go')}}</a>
                </button>
            </div>
        </div>
    </div>
...
<span style="display: none;">
    <button type="button" class="btn btn-primary" id="notification_rejected_rental_order_ride_id" data-toggle="modal" data-target="#notification_rejected_rental_ride_id">{{trans('lang.large_modal')}}</button>
</span>

<div class="modal fade" id="notification_rejected_rental_ride_id" tabindex="-1" role="dialog" aria-labelledby="notification_rejected_dining_by_restaurant" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered notification-main" role="document">
        <div class="modal-content">
            <div class="modal-header justify-content-center " style="display: block;">
                <h5 class="modal-title text-center" id="exampleModalLongTitle">{{trans('lang.start_ride')}}</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            ...
            if ($("#section_lists").html() == '') {
                ...
                sectionsRef.get().then(async function(snapshots) {
                    ...
                    snapshots.docs.forEach((section) => {
                        ...
                        html =
                            '<div class="section-list-inner col-md-3 mb-4 select_section" data-color="' +
                            datas.color + '" service_type="' + datas.serviceType + '" data-name="' +
                            datas.name + '" data-dine_in="' + datas.dine_in_active + '" data-id="' +
                            datas.id + '">' +
                            '<div class="section-block bg-white rounded d-block py-3 px-2 text-center shadow-lg">' +
                            '<span class="section-img"><img alt="#" src="' + section_image +
                            '" class="img-fluid item-img w-100"></span>' +
                            '<span class="section-name mt-2 d-block">' + datas.name +
                            '</span></div></div>';
        ...
        if ($("#section_lists").html() == '') {
            ...
            sectionsRef.get().then(async function(snapshots) {
                ...
                snapshots.docs.forEach((section) => {
                    ...
                    html = '<div class="section-list-inner col-md-3 mb-4 select_section ' +
                        active_section + '" service_type="' + datas.serviceType +
                        '"data-color="' + datas.color + '" data-name="' + datas.name +
                        '" data-id="' + datas.id + '" data-dine_in="' + datas.dine_in_active +
                        '"><div class="section-block bg-white rounded d-block py-3 px-2 text-center shadow-lg"><span class="section-img"><img alt="#" src="' +
                        section_image +
                        '" class="img-fluid item-img w-100"></span><span class="section-name mt-2 d-block">' +
                        datas.name + '</span></div></div>';
...
<script type="text/javascript">
    ...
    ref.get().then(async function(snapshots) {
        ...
        $("#emart2.png").attr('src', globalSettings.appLogo);
        $("#footer_emart2.png").attr('src', globalSettings.appLogo);
    });
            ...
            user_ref.get().then(async function(profileSnapshots) {
                if (profileSnapshots.docs.length) {
                    ...
                    if (profile_user.profilePictureURL != '') {
                        $("#dropdownMenuButton").append('<img alt="#" src="' + profile_user
                            .profilePictureURL +
                ...
                doc.docChanges().forEach(function(change) {
                    ...
                    if (change.type == "modified") {
                        ...
                        if (val.status == "Order Completed") {
                            ...
                            const driverData = getRentalDriver(val.driverID);
                            if (routerental) {
                                $("#notification_accepted_rental_a").attr("href", routerental.replace(':id', val
                                    .id));
                            }
        ...
        if (snapshotslang != undefined) {
            ...
            snapshotslang.forEach((data) => {
                if (data.isActive == true) {
                    langcount++;
                    $('#language_dropdown').append($("<option></option>").attr("value", data.slug).text(
                        data.title));
                }
            });
            if (langcount > 1) {
