...
<head>
    ...
    <link rel="icon" type="image/png" href="{{asset('img/emart2.png')}}">
    <title><?php echo env('APP_NAME'); ?> - Online Item Ordering System</title>

    <link rel="stylesheet" type="text/css" href="{{asset('vendor/slick/slick.min.css')}}" />
    <link rel="stylesheet" type="text/css" href="{{asset('vendor/slick/slick-theme.min.css')}}" />
    <link
        href="https://fonts.googleapis.com/css2?family=Poppins:ital,wght@0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,300;1,400;1,500;1,600;1,700&display=swap"
        rel="stylesheet">
    ...
    .rental-left-box .nav-pills-custom .nav-link.active::before {
        border-left-color: <?php echo $_COOKIE['section_color'];
        ?>;
        border-right-color: <?php echo $_COOKIE['section_color'];
        ?>;
    }
    ...
    .parcel_payment_left .coupon_detail .copupon-list ul li a:hover {
        background: <?php echo $_COOKIE['section_color'];
        ?>;
        border-color: <?php echo $_COOKIE['section_color'];
        ?>;
    ...
    .order-summery .payment-total.total-price span.price,
    .brand span a:hover,
    .store span a:hover,
    ...
    .vandor-sidebar .vandorcat-list li a:hover,
    .vandor-sidebar .vandorcat-list li.active a {
        border-left: 3px solid <?php echo $_COOKIE['section_color'];
        ?>;
    }
    ...
    .section_list .section-block:hover,
    .section_list .section-selected .section-block {
        border-color: <?php echo $_COOKIE['section_color'];
        ?> !important;
    }

    .parcel_payment-way ul li input[type="radio"]:checked~label::after {
        border-color: <?php echo $_COOKIE['section_color'];
        ?>;
    }
