        ...
        if (takeaway_options == true) {
            if (takeAway.checked == false) {
                ...
                let isExecuted = confirm(
                    "If you select take away option then it will empty cart. are you sure want to do ?");
                if (isExecuted) {} else {
                    return false;
                }
            }
            ...
            <div class="row align-items-center">
                <div class="col-2">
                    <a href="{{url('/')}}" class="brand-wrap mb-0">
                        <img alt="#" class="img-fluid" src="{{asset('img/emart2.png')}}" id="emart2.png">
                    </a>
                </div>
                    ...
                    <div class="d-flex align-items-center justify-content-end pr-5">
                        ...
                        <div class="icon d-flex align-items-center text-dark takeaway-div">
                            <span class="takeaway-btn">
                                ...
                                <input type="checkbox" onclick="takeAwayOnOff(this)"> <span class="slider round"></span>
                            </span>
                        </div>
                        <?php    } ?>
                        <?php } ?>
...
<div class="d-none">
    <div class="bg-primary p-3 d-flex align-items-center">
        ...
        <a href="{{url('/')}}" class="mobile-logo brand-wrap mb-0">
            <img alt="#" class="img-fluid" src="{{asset('img/emart2.png')}}">
        </a>
    </div>
</div>